...
//LOGO
extern void fd(), bk(), rt(), lta(), ct(), cs(), penup(), pendown(), repeata(), sethang(), pcolor();
...
extern void insertar(float x, float y, float dx, float dy, char penup_pendown, float r, float g, float b);
//Eliminar los puntos
